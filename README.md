...
# 3. Install
After downloading the source file, unzip it, and <font color=gray>add the iREAD package path to your environmental variable PATH</font> by modifying your .bashrc or .bash_profile file in your home directory.
